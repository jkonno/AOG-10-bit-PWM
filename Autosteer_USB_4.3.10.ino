...
////////////////// User Settings /////////////////////////
  ...
  #define ROLL_DSP_STEP 1

  //PWM Frequency -> 490hz (default) = 0 and -> 122hz = 1  -> 3921hz = 2 --> 10 bit PWM = 3
  #define PWM_Frequency 3
...
{ 
  ...
  {
    Timer1.initialize(8000);  // 8000 us = 125 Hz rounded to nearest
  }
